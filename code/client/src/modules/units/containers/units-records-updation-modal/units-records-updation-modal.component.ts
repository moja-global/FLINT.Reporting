...
import { UnitsRecordsUpdationComponent } from '../../components/units-records-updation/units-records-updation.component';
...
@Component({
    selector: 'sb-units-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './units-records-updation-modal.component.html',
    styleUrls: ['units-records-updation-modal.component.scss'],
})
export class UnitsRecordsUpdationModalComponent implements OnInit {
    ...
    @ViewChild(UnitsRecordsUpdationComponent) component!: UnitsRecordsUpdationComponent;
     ...
     * propagates the saving request to the Units records updation component
     */
    onSave() {
