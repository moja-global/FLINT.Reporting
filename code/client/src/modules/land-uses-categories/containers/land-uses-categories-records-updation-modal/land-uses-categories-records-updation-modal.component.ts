...
import { LandUsesCategoriesRecordsUpdationComponent } from '../../components/land-uses-categories-records-updation/land-uses-categories-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';


const LOG_PREFIX: string = "[Land Uses Categories Records Updation Modal]";

@Component({
    selector: 'sb-land-uses-categories-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './land-uses-categories-records-updation-modal.component.html',
    styleUrls: ['land-uses-categories-records-updation-modal.component.scss'],
})
export class LandUsesCategoriesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the LandUsesCategories records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(LandUsesCategoriesRecordsUpdationComponent) component!: LandUsesCategoriesRecordsUpdationComponent;
     ...
     * propagates the saving request to the LandUsesCategories records updation component
     */
    onSave() {
