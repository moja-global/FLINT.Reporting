...
import { LandUsesCategoriesRecordsCreationComponent } from '../../components/land-uses-categories-records-creation/land-uses-categories-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Land Uses Categories Records Creation Modal]";

@Component({
    selector: 'sb-land-uses-categories-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './land-uses-categories-records-creation-modal.component.html',
    styleUrls: ['land-uses-categories-records-creation-modal.component.scss'],
})
export class LandUsesCategoriesRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    // Inject a reference to the LandUsesCategories records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(LandUsesCategoriesRecordsCreationComponent) component!: LandUsesCategoriesRecordsCreationComponent;
     ...
     * propagates the saving request to the LandUsesCategories records creation component
     */
    onSave() {
