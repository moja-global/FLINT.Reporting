...
import { DatabasesRecordsUpdationComponent } from '../../components/databases-records-updation/databases-records-updation.component';
...
const LOG_PREFIX: string = "[Databases Records Updation Modal]";

@Component({
    selector: 'sb-databases-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './databases-records-updation-modal.component.html',
    styleUrls: ['databases-records-updation-modal.component.scss'],
})
export class DatabasesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Databases records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(DatabasesRecordsUpdationComponent) component!: DatabasesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Databases records updation component
     */
    onSave() {
