...
import { DatabasesRecordsDeletionComponent } from '../../components/databases-records-deletion/databases-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';
import { ConnectivityStatusService } from '@common/services';

const LOG_PREFIX: string = "[Databases Records Deletion Modal]";

@Component({
    selector: 'sb-databases-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './databases-records-deletion-modal.component.html',
    styleUrls: ['databases-records-deletion-modal.component.scss'],
})
export class DatabasesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Databases records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(DatabasesRecordsDeletionComponent) component!: DatabasesRecordsDeletionComponent;
    ...
    constructor(
        public activeDatabasesModal: NgbActiveModal,
     ...
     * propagates the deletion request to the Databases records creation component
     */
    onDelete() {
    ...
    onQuit() {
        ...
        this.activeDatabasesModal.close();
    }
