...
import { DatabasesRecordsCreationComponent } from '../../components/databases-records-creation/databases-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';
import { ConnectivityStatusService } from '@common/services';

const LOG_PREFIX: string = "[Databases Records Creation Modal]";

@Component({
    selector: 'sb-databases-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './databases-records-creation-modal.component.html',
    styleUrls: ['databases-records-creation-modal.component.scss'],
})
export class DatabasesRecordsCreationModalComponent implements OnInit {


    // Inject a reference to the Databases records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(DatabasesRecordsCreationComponent) component!: DatabasesRecordsCreationComponent;
     ...
     * propagates the saving request to the Databases records creation component
     */
    onSave() {
