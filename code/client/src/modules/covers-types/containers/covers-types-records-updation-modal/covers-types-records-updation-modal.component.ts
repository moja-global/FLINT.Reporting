...
import { CoversTypesRecordsUpdationComponent } from '../../components/covers-types-records-updation/covers-types-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';


const LOG_PREFIX: string = "[Covers Types Records Updation Modal]";

@Component({
    selector: 'sb-covers-types-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './covers-types-records-updation-modal.component.html',
    styleUrls: ['covers-types-records-updation-modal.component.scss'],
})
export class CoversTypesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Covers Types Records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(CoversTypesRecordsUpdationComponent) component!: CoversTypesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Covers Types Records updation component
     */
    onSave() {
