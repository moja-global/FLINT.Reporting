...
import { CoversTypesRecordsDeletionComponent } from '../../components/covers-types-records-deletion/covers-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';

const LOG_PREFIX: string = "[Covers Types Records Deletion Modal]";

@Component({
    selector: 'sb-covers-types-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './covers-types-records-deletion-modal.component.html',
    styleUrls: ['covers-types-records-deletion-modal.component.scss'],
})
export class CoversTypesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Covers Types Records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(CoversTypesRecordsDeletionComponent) component!: CoversTypesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Covers Types Records creation component
     */
    onDelete() {
