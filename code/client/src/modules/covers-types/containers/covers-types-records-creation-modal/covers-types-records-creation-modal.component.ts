...
import { CoversTypesRecordsCreationComponent } from '../../components/covers-types-records-creation/covers-types-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Covers Types Records Creation Modal]";

@Component({
    selector: 'sb-covers-types-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './covers-types-records-creation-modal.component.html',
    styleUrls: ['covers-types-records-creation-modal.component.scss'],
})
export class CoversTypesRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    // Inject a reference to the Covers Types Records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(CoversTypesRecordsCreationComponent) component!: CoversTypesRecordsCreationComponent;
    ...
    constructor(
        public activeCoversTypesModal: NgbActiveModal,
     ...
     * propagates the saving request to the Covers Types Records creation component
     */
    onSave() {
    ...
    onQuit() {
        ...
        this.activeCoversTypesModal.close();
    }
