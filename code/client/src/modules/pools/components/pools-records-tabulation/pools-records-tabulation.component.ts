...
const LOG_PREFIX: string = "[Pools Records Tabulation Component]";
...
export class PoolsRecordsTabulationComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    constructor(
        ...
        public poolsRecordsTabulationService: PoolsRecordsTabulationService,        
    ...
    ngAfterViewInit() {
        ...
        this.pagination.initialize(this.poolsRecordsTabulationService.page, this.pageSize);
        ...
        this._subscriptions.push(
            this.poolsRecordsTabulationService.total$.subscribe(
                (total) => {
        ...
        this._subscriptions.push(
            this.poolsRecordsTabulationService.loading$.subscribe(
                (loading) => {
    ...
    onSearch(event: any) {
        ...
        this.poolsRecordsTabulationService.searchTerm = event;
        this.cd.detectChanges();
    }
    ...
    onSort({ column, direction }: SortEvent) {
        ...
        this.poolsRecordsTabulationService.sortColumn = column;
        this.poolsRecordsTabulationService.sortDirection = direction;
        this.cd.detectChanges();
    }
    ...
    onPageChange(event: any) {
        ...
        this.poolsRecordsTabulationService.page = event;
        this.cd.detectChanges();
    }
    ...
    onPageSizeChange(event: any) {
        ...
        this.poolsRecordsTabulationService.pageSize = event;
        this.cd.detectChanges();
    }
