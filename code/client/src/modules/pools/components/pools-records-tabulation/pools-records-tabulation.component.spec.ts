...
import { PoolsDataService, PoolsRecordsTabulationService } from '@modules/pools/services';
...
@Component({
    template: `
        <sb-pools-records-tabulation [someInput]="someInput" (someFunction)="someFunction($event)"></sb-pools-records-tabulation>
    `,
})
...
describe('PoolsRecordsTabulationComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, PoolsRecordsTabulationComponent, PaginationComponent, LoadingAnimationComponent],
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('sb-pools-records-tabulation')).toEqual(jasmine.anything());
    });
});