...
import { PoolsRecordsUpdationComponent } from '../../components/pools-records-updation/pools-records-updation.component';
...
@Component({
    selector: 'sb-pools-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './pools-records-updation-modal.component.html',
    styleUrls: ['pools-records-updation-modal.component.scss'],
})
export class PoolsRecordsUpdationModalComponent implements OnInit {
