...
import { PoolsRecordsCreationComponent } from '../../components/pools-records-creation/pools-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Pools Records Creation Modal]";

@Component({
    selector: 'sb-pools-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './pools-records-creation-modal.component.html',
    styleUrls: ['pools-records-creation-modal.component.scss'],
})
export class PoolsRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    // Inject a reference to the Pools Records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(PoolsRecordsCreationComponent) component!: PoolsRecordsCreationComponent;
     ...
     * propagates the saving request to the Pools Records creation component
     */
    onSave() {
