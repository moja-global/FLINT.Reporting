...
import { LandUseSubcategoriesRecordsCreationComponent } from '@modules/land-use-subcategories/components/land-use-subcategories-records-creation/land-use-subcategories-records-creation.component';

const LOG_PREFIX: string = "[Land Use Subcategories Records Creation Modal]";

@Component({
    selector: 'sb-land-use-subcategories-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './land-use-subcategories-records-creation-modal.component.html',
    styleUrls: ['land-use-subcategories-records-creation-modal.component.scss'],
})
export class LandUseSubcategoriesRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    // Inject a reference to the Land Use Subcategories records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(LandUseSubcategoriesRecordsCreationComponent) component!: LandUseSubcategoriesRecordsCreationComponent;
    ...
    constructor(
        public activeLandUseSubcategoriesModal: NgbActiveModal,
     ...
     * propagates the saving request to the Land Use Subcategories records creation component
     */
    onSave() {
    ...
    onQuit() {
        ...
        this.activeLandUseSubcategoriesModal.close();
    }
