...
import { LandUseSubcategoriesRecordsUpdationComponent } from '@modules/land-use-subcategories/components/land-use-subcategories-records-updation/land-use-subcategories-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';


const LOG_PREFIX: string = "[Land Use Subcategories Records Updation Modal]";

@Component({
    selector: 'sb-land-use-subcategories-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './land-use-subcategories-records-updation-modal.component.html',
    styleUrls: ['land-use-subcategories-records-updation-modal.component.scss'],
})
export class LandUseSubcategoriesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Land Use Subcategories records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(LandUseSubcategoriesRecordsUpdationComponent) component!: LandUseSubcategoriesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Land Use Subcategories records updation component
     */
    onSave() {
