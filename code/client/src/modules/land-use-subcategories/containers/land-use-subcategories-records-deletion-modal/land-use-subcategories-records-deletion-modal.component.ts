...
import { LandUseSubcategoriesRecordsDeletionComponent } from '@modules/land-use-subcategories/components/land-use-subcategories-records-deletion/land-use-subcategories-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';

const LOG_PREFIX: string = "[Land Use Subcategories Records Deletion Modal]";

@Component({
    selector: 'sb-land-use-subcategories-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './land-use-subcategories-records-deletion-modal.component.html',
    styleUrls: ['land-use-subcategories-records-deletion-modal.component.scss'],
})
export class LandUseSubcategoriesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Land Use Subcategories records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(LandUseSubcategoriesRecordsDeletionComponent) component!: LandUseSubcategoriesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Land Use Subcategories records creation component
     */
    onDelete() {
