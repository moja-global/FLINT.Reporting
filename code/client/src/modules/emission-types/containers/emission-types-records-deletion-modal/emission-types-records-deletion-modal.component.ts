...
import { EmissionTypesRecordsDeletionComponent } from '../../components/emission-types-records-deletion/emission-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';
import { ConnectivityStatusService } from '@common/services';

const LOG_PREFIX: string = "[Emission Types Records Deletion Modal]";

@Component({
    selector: 'sb-emission-types-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './emission-types-records-deletion-modal.component.html',
    styleUrls: ['emission-types-records-deletion-modal.component.scss'],
})
export class EmissionTypesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Emission Types records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(EmissionTypesRecordsDeletionComponent) component!: EmissionTypesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Emission Types records creation component
     */
    onDelete() {
    ...
    onQuit() {
        ...
        this.activeEmissionTypesModal.close();
    }
