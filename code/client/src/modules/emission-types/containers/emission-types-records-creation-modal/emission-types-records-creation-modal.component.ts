...
import { EmissionTypesRecordsCreationComponent } from '../../components/emission-types-records-creation/emission-types-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';
import { ConnectivityStatusService } from '@common/services';

const LOG_PREFIX: string = "[Emission Types Records Creation Modal]";

@Component({
    selector: 'sb-emission-types-records-creation-modal',
...
export class EmissionTypesRecordsCreationModalComponent implements OnInit {
    ...
    // Inject a reference to the Emission Types records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(EmissionTypesRecordsCreationComponent) component!: EmissionTypesRecordsCreationComponent;
     ...
     * propagates the saving request to the Emission Types records creation component
     */
    onSave() {
