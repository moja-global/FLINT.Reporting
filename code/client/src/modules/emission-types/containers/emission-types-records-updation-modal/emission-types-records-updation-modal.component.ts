...
import { EmissionTypesRecordsUpdationComponent } from '../../components/emission-types-records-updation/emission-types-records-updation.component';
...
const LOG_PREFIX: string = "[Emission Types Records Updation Modal]";

@Component({
    selector: 'sb-emission-types-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './emission-types-records-updation-modal.component.html',
    styleUrls: ['emission-types-records-updation-modal.component.scss'],
})
export class EmissionTypesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Emission Types records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(EmissionTypesRecordsUpdationComponent) component!: EmissionTypesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Emission Types records updation component
     */
    onSave() {
