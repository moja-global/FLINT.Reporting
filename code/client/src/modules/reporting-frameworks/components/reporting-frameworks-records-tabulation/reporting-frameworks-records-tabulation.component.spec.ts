...
import { ReportingFrameworksDataService, ReportingFrameworksRecordsTabulationService } from '@modules/reporting-frameworks/services';
...
@Component({
    template: `
        <sb-reporting-frameworks-records-tabulation [someInput]="someInput" (someFunction)="someFunction($event)"></sb-reporting-frameworks-records-tabulation>
    `,
})
...
describe('ReportingFrameworksRecordsTabulationComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, ReportingFrameworksRecordsTabulationComponent, PaginationComponent, LoadingAnimationComponent],
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('sb-reporting-frameworks-records-tabulation')).toEqual(jasmine.anything());
    });
});