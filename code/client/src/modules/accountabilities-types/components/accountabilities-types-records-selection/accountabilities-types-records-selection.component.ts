...
const LOG_PREFIX: string = "[Accountabilities Types Records Selection Component]";

@Component({
    selector: 'sb-accountabilities-types-records-selection',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './accountabilities-types-records-selection.component.html',
    styleUrls: ['accountabilities-types-records-selection.component.scss'],
})
export class AccountabilitiesTypesRecordsSelectionComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    constructor(
        public accountabilitiesTypesTableService: AccountabilitiesTypesRecordsTabulationService,
    ...
    ngAfterViewInit() {
        ...
        this.pagination.initialize(this.accountabilitiesTypesTableService.page, this.pageSize);
        ...
        this._subscriptions.push(
            this.accountabilitiesTypesTableService.total$.subscribe(
                (total) => {
        ...
        this._subscriptions.push(
            this.accountabilitiesTypesTableService.loading$.subscribe(
                (loading) => {
    ...
    onSearch(event: any) {
        ...
        this.accountabilitiesTypesTableService.searchTerm = event;
        this.cd.detectChanges();
    }
    ...
    onSort({ column, direction }: SortEvent) {
        ...
        this.accountabilitiesTypesTableService.sortColumn = column;
        this.accountabilitiesTypesTableService.sortDirection = direction;
        this.cd.detectChanges();
    }
    ...
    onPageChange(event: any) {
        ...
        this.accountabilitiesTypesTableService.page = event;
        this.cd.detectChanges();
    }
    ...
    onPageSizeChange(event: any) {
        ...
        this.accountabilitiesTypesTableService.pageSize = event;
        this.cd.detectChanges();
    }
    ...
    */
    onSelect(id: number) {
        this.log.trace(`${LOG_PREFIX} Selected Accountability Type Id: ${id}`);
    ...
    */
    onCheck(id: number) {
        this.log.trace(`${LOG_PREFIX} Checked Accountability Type Id: ${id}`);
    ...
    */
    onUncheck(id: number) {
        ...
        this.log.trace(`${LOG_PREFIX} Unchecked Accountability Type Id: ${id}`);
    ...
    isSelected(accountabilityTypeId: number) {
        return this.selectedAccountabilityTypeIds.some(id => id == accountabilityTypeId);
    }
    ...
    isSelectedOrChecked(accountabilityTypeId: number) {
        return this.selectedAccountabilityTypeIds.some(id => id == accountabilityTypeId);
    }    
