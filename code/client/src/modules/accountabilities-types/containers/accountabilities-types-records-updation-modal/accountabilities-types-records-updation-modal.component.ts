...
import { AccountabilitiesTypesRecordsUpdationComponent } from '../../components/accountabilities-types-records-updation/accountabilities-types-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';


const LOG_PREFIX: string = "[Accountabilities Types Records Updation Modal]";

@Component({
    selector: 'sb-accountabilities-types-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './accountabilities-types-records-updation-modal.component.html',
    styleUrls: ['accountabilities-types-records-updation-modal.component.scss'],
})
export class AccountabilitiesTypesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Accountabilities Types Records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(AccountabilitiesTypesRecordsUpdationComponent) component!: AccountabilitiesTypesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Accountabilities Types Records updation component
     */
    onSave() {
