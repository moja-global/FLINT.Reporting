...
import { AccountabilitiesTypesRecordsDeletionComponent } from '../../components/accountabilities-types-records-deletion/accountabilities-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';

const LOG_PREFIX: string = "[Accountabilities Types Records Deletion Modal]";

@Component({
    selector: 'sb-accountabilities-types-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './accountabilities-types-records-deletion-modal.component.html',
    styleUrls: ['accountabilities-types-records-deletion-modal.component.scss'],
})
export class AccountabilitiesTypesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Accountabilities Types Records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(AccountabilitiesTypesRecordsDeletionComponent) component!: AccountabilitiesTypesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Accountabilities Types Records creation component
     */
    onDelete() {
