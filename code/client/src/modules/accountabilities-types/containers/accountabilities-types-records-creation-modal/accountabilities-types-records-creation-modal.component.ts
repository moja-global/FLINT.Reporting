...
import { AccountabilitiesTypesRecordsCreationComponent } from '../../components/accountabilities-types-records-creation/accountabilities-types-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Accountabilities Types Records Creation Modal]";

@Component({
    selector: 'sb-accountabilities-types-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './accountabilities-types-records-creation-modal.component.html',
    styleUrls: ['accountabilities-types-records-creation-modal.component.scss'],
})
export class AccountabilitiesTypesRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    // Inject a reference to the Accountabilities Types Records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(AccountabilitiesTypesRecordsCreationComponent) component!: AccountabilitiesTypesRecordsCreationComponent;
    ...
    constructor(
        public activeAccountabilitiesTypesModal: NgbActiveModal,
     ...
     * propagates the saving request to the Accountabilities Types Records creation component
     */
    onSave() {
    ...
    onQuit() {
        ...
        this.activeAccountabilitiesTypesModal.close();
    }
