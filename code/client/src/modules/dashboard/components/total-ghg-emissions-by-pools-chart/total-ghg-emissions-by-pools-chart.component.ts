...
const LOG_PREFIX: string = "[Total-GHG-Emissions-By-Pools-Chart-Component]";

@Component({
    selector: 'sb-total-ghg-emissions-by-pools-chart',
    templateUrl: './total-ghg-emissions-by-pools-chart.component.html',
    styleUrls: ['./total-ghg-emissions-by-pools-chart.component.scss']
})
export class TotalGHGEmissionsByPoolsChartComponent implements OnInit, AfterViewInit {
    ...
    private basicColumnChartOptions: any = {
        ...
        title: {
            text: 'Total GHG Emissions - By Carbon Pools'
        },
        subtitle: {
    ...
    private loadChart(): void {
        ...
        this._yearsSubject$.value.forEach(year => {
            ...
            let a = ycategories.find(s => s.name === "Living Biomass");
            ...
            let b = ycategories.find(s => s.name === "Dead Organic Matter");
            ...
            let c = ycategories.find(s => s.name === "Mineral Soils");
            ...
            let d = ycategories.find(s => s.name === "Organic Soils");
