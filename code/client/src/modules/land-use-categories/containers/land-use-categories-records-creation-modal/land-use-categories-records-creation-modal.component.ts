...
import { LandUseCategoriesRecordsCreationComponent } from '@modules/land-use-categories/components/land-use-categories-records-creation/land-use-categories-records-creation.component';

const LOG_PREFIX: string = "[Land Use Categories Records Creation Modal]";

@Component({
    selector: 'sb-land-use-categories-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './land-use-categories-records-creation-modal.component.html',
    styleUrls: ['land-use-categories-records-creation-modal.component.scss'],
})
export class LandUseCategoriesRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    // Inject a reference to the Land Use Categories records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(LandUseCategoriesRecordsCreationComponent) component!: LandUseCategoriesRecordsCreationComponent;
     ...
     * propagates the saving request to the Land Use Categories records creation component
     */
    onSave() {
