...
import { UnitCategoriesRecordsDeletionComponent } from '../../components/unit-categories-records-deletion/unit-categories-records-deletion.component';
...
@Component({
    ...
    templateUrl: './unit-categories-records-deletion-modal.component.html',
    styleUrls: ['unit-categories-records-deletion-modal.component.scss'],
})
export class UnitCategoriesRecordsDeletionModalComponent implements OnInit {
