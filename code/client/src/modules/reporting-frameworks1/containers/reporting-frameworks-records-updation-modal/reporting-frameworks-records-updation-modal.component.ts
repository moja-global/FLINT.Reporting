...
import { ReportingFrameworksRecordsUpdationComponent } from '../../components/reporting-frameworks-records-updation/reporting-frameworks-records-updation.component';
...
@Component({
    selector: 'sb-reporting-frameworks-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './reporting-frameworks-records-updation-modal.component.html',
    styleUrls: ['reporting-frameworks-records-updation-modal.component.scss'],
})
export class ReportingFrameworksRecordsUpdationModalComponent implements OnInit {
