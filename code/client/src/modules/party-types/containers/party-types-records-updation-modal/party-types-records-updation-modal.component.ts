...
import { PartyTypesRecordsUpdationComponent } from '../../components/party-types-records-updation/party-types-records-updation.component';
...
const LOG_PREFIX: string = "[Party Types Records Updation Modal]";

@Component({
    selector: 'sb-party-types-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './party-types-records-updation-modal.component.html',
    styleUrls: ['party-types-records-updation-modal.component.scss'],
})
export class PartyTypesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Party Types records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(PartyTypesRecordsUpdationComponent) component!: PartyTypesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Party Types records updation component
     */
    onSave() {
