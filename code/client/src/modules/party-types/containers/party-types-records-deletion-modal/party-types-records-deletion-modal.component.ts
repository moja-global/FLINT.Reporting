...
import { PartyTypesRecordsDeletionComponent } from '../../components/party-types-records-deletion/party-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';
import { PartyType } from '@modules/party-types/models';

const LOG_PREFIX: string = "[Party Types Records Deletion Modal]";

@Component({
    selector: 'sb-party-types-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './party-types-records-deletion-modal.component.html',
    styleUrls: ['party-types-records-deletion-modal.component.scss'],
})
export class PartyTypesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Party Types records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(PartyTypesRecordsDeletionComponent) component!: PartyTypesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Party Types records creation component
     */
    onDelete() {
