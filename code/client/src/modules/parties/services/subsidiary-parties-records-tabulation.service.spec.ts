...
describe('SubsidiaryPartiesRecordsTabulationService', () => {

    let partiesDataService: PartiesDataService;
    let partiesTableDataService: SubsidiaryPartiesRecordsTabulationService;
    ...
    beforeEach(() => {
        ...
        partiesTableDataService = TestBed.inject(SubsidiaryPartiesRecordsTabulationService);
