...
import { EmissionsTypesRecordsCreationComponent } from '../../components/emissions-types-records-creation/emissions-types-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Emissions Types Records Creation Modal]";

@Component({
    selector: 'sb-emissions-types-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './emissions-types-records-creation-modal.component.html',
    styleUrls: ['emissions-types-records-creation-modal.component.scss'],
})
export class EmissionsTypesRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    // Inject a reference to the Emissions Types Records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(EmissionsTypesRecordsCreationComponent) component!: EmissionsTypesRecordsCreationComponent;
    ...
    constructor(
        public activeEmissionsTypesModal: NgbActiveModal,
     ...
     * propagates the saving request to the Emissions Types Records creation component
     */
    onSave() {
    ...
    onQuit() {
        ...
        this.activeEmissionsTypesModal.close();
    }
