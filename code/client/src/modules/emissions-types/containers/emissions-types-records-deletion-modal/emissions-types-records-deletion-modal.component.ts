...
import { EmissionsTypesRecordsDeletionComponent } from '../../components/emissions-types-records-deletion/emissions-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';

const LOG_PREFIX: string = "[Emissions Types Records Deletion Modal]";

@Component({
    selector: 'sb-emissions-types-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './emissions-types-records-deletion-modal.component.html',
    styleUrls: ['emissions-types-records-deletion-modal.component.scss'],
})
export class EmissionsTypesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Emissions Types Records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(EmissionsTypesRecordsDeletionComponent) component!: EmissionsTypesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Emissions Types Records creation component
     */
    onDelete() {
