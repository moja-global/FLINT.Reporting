...
import { EmissionsTypesRecordsUpdationComponent } from '../../components/emissions-types-records-updation/emissions-types-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';


const LOG_PREFIX: string = "[Emissions Types Records Updation Modal]";

@Component({
    selector: 'sb-emissions-types-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './emissions-types-records-updation-modal.component.html',
    styleUrls: ['emissions-types-records-updation-modal.component.scss'],
})
export class EmissionsTypesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Emissions Types Records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(EmissionsTypesRecordsUpdationComponent) component!: EmissionsTypesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Emissions Types Records updation component
     */
    onSave() {
