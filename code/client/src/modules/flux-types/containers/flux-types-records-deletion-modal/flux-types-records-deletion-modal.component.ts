...
import { FluxTypesRecordsDeletionComponent } from '../../components/flux-types-records-deletion/flux-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';
import { ConnectivityStatusService } from '@common/services';

const LOG_PREFIX: string = "[Flux Types Records Deletion Modal]";

@Component({
    selector: 'sb-flux-types-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './flux-types-records-deletion-modal.component.html',
    styleUrls: ['flux-types-records-deletion-modal.component.scss'],
})
export class FluxTypesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Flux Types records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(FluxTypesRecordsDeletionComponent) component!: FluxTypesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Flux Types records creation component
     */
    onDelete() {
