...
describe('FluxTypesRecordsTabulationComponent', () => {

    let fixture: ComponentFixture<FluxTypesRecordsTabulationComponent>;
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [LoadingAnimationComponent, PaginationComponent, FluxTypesRecordsTabulationComponent],
        ...
        fixture = TestBed.createComponent(FluxTypesRecordsTabulationComponent);
    ...
    it('should display the Flux Types headers correctly', () => {
    ...
    it('should trigger the search for Flux Types records with the specified search term', () => {

        const searchTermSetter = spyOnProperty(component.fluxTypesTableService, 'searchTerm', 'set');
    ...
    it('should trigger the loading of the Flux Types records page change', () => {

        const pageSetter = spyOnProperty(component.fluxTypesTableService, 'page', 'set');
    ...
    it('should trigger the loading of the Flux Types records page size change', () => {

        const pageSizeSetter = spyOnProperty(component.fluxTypesTableService, 'pageSize', 'set');
    ...
    it('should trigger the sorting of Flux Types records by name', () => {

        const sortColumnSetter = spyOnProperty(component.fluxTypesTableService, 'sortColumn', 'set');
        const sortDirectionSetter = spyOnProperty(component.fluxTypesTableService, 'sortDirection', 'set');
