...
const LOG_PREFIX: string = "[Flux Types Records Creation Component]";

@Component({
  selector: 'sb-flux-types-records-creation',
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './flux-types-records-creation.component.html',
  styleUrls: ['flux-types-records-creation.component.scss'],
})
export class FluxTypesRecordsCreationComponent implements OnInit {
  ...
  public save(): void {
    ...
    if (this.fluxTypesForm.valid) {
      ...
      this.fluxTypesDataService
        .createFluxType(new FluxType({ name, description }))
        .subscribe(
          (response: FluxType) => {
