...
import { AccountabilitiesRecordsTabulationService } from './accountabilities-records-tabulation.service';

describe('AccountabilitiesRecordsTabulationService', () => {

    let accountabilitiesDataService: AccountabilitiesDataService;
    let accountabilitiesTableDataService: AccountabilitiesRecordsTabulationService;
    ...
    beforeEach(() => {
        ...
        accountabilitiesTableDataService = TestBed.inject(AccountabilitiesRecordsTabulationService);
