...
import { ReportingTablesRecordsDeletionComponent } from '@modules/reporting-tables/components/reporting-tables-records-deletion/reporting-tables-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';

const LOG_PREFIX: string = "[Reporting Tables Records Deletion Modal]";

@Component({
    selector: 'sb-reporting-tables-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './reporting-tables-records-deletion-modal.component.html',
    styleUrls: ['reporting-tables-records-deletion-modal.component.scss'],
})
export class ReportingTablesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Reporting Tables records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(ReportingTablesRecordsDeletionComponent) component!: ReportingTablesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Reporting Tables records creation component
     */
    onDelete() {
