...
import { CoverTypesRecordsDeletionComponent } from '../../components/cover-types-records-deletion/cover-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';
import { ConnectivityStatusService } from '@common/services';

const LOG_PREFIX: string = "[Cover Types Records Deletion Modal]";

@Component({
    selector: 'sb-cover-types-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './cover-types-records-deletion-modal.component.html',
    styleUrls: ['cover-types-records-deletion-modal.component.scss'],
})
export class CoverTypesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Cover Types records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(CoverTypesRecordsDeletionComponent) component!: CoverTypesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Cover Types records creation component
     */
    onDelete() {
