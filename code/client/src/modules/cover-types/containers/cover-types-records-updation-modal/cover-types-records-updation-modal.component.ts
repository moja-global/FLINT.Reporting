...
import { CoverTypesRecordsUpdationComponent } from '../../components/cover-types-records-updation/cover-types-records-updation.component';
...
const LOG_PREFIX: string = "[Cover Types Records Updation Modal]";

@Component({
    selector: 'sb-cover-types-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './cover-types-records-updation-modal.component.html',
    styleUrls: ['cover-types-records-updation-modal.component.scss'],
})
export class CoverTypesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Cover Types records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(CoverTypesRecordsUpdationComponent) component!: CoverTypesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Cover Types records updation component
     */
    onSave() {
