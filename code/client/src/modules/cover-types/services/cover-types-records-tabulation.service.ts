...
const LOG_PREFIX: string = "[Cover Types Records Tabulation Data Service]";

@Injectable({ providedIn: 'root' })
export class CoverTypesRecordsTabulationService implements OnInit, OnDestroy {
            ...
            this.connectivityStatusService.online$.subscribe(status => {
                ...
                if (this.online) {
                    ...
                    if (!this.isInitialized) {
                        ...
                        if (this.coverTypesDataService.records.length == 0) {
                            ...
                            this.coverTypesDataService
                                ...
                                .subscribe((coverTypes: CoverType[]) => {
