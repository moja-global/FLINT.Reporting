...
import { PartiesTypesRecordsCreationComponent } from '../../components/parties-types-records-creation/parties-types-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Parties Types Records Creation Modal]";

@Component({
    selector: 'sb-parties-types-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './parties-types-records-creation-modal.component.html',
    styleUrls: ['parties-types-records-creation-modal.component.scss'],
})
export class PartiesTypesRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    // Inject a reference to the Parties Types Records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(PartiesTypesRecordsCreationComponent) component!: PartiesTypesRecordsCreationComponent;
    ...
    constructor(
        public activePartiesTypesModal: NgbActiveModal,
     ...
     * propagates the saving request to the Parties Types Records creation component
     */
    onSave() {
    ...
    onQuit() {
        ...
        this.activePartiesTypesModal.close();
    }
