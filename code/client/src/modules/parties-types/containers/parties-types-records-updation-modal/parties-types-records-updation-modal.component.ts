...
import { PartiesTypesRecordsUpdationComponent } from '../../components/parties-types-records-updation/parties-types-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';


const LOG_PREFIX: string = "[Parties Types Records Updation Modal]";

@Component({
    selector: 'sb-parties-types-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './parties-types-records-updation-modal.component.html',
    styleUrls: ['parties-types-records-updation-modal.component.scss'],
})
export class PartiesTypesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Parties Types Records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(PartiesTypesRecordsUpdationComponent) component!: PartiesTypesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Parties Types Records updation component
     */
    onSave() {
