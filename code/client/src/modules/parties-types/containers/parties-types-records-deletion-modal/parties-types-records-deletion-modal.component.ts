...
import { PartiesTypesRecordsDeletionComponent } from '../../components/parties-types-records-deletion/parties-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';

const LOG_PREFIX: string = "[Parties Types Records Deletion Modal]";

@Component({
    selector: 'sb-parties-types-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './parties-types-records-deletion-modal.component.html',
    styleUrls: ['parties-types-records-deletion-modal.component.scss'],
})
export class PartiesTypesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Parties Types Records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(PartiesTypesRecordsDeletionComponent) component!: PartiesTypesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Parties Types Records creation component
     */
    onDelete() {
