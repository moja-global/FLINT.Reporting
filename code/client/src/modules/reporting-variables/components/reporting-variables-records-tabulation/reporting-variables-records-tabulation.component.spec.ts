...
import { ReportingVariablesRecordsTabulationService } from '@modules/reporting-variables/services';
import { LoggerModule, NgxLoggerLevel } from 'ngx-logger';
import { of } from 'rxjs/internal/observable/of';

import { ReportingVariablesRecordsTabulationComponent } from './reporting-variables-records-tabulation.component';

describe('ReportingVariablesRecordsTabulationComponent', () => {

    let fixture: ComponentFixture<ReportingVariablesRecordsTabulationComponent>;

    let component: ReportingVariablesRecordsTabulationComponent;
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [PaginationComponent, LoadingAnimationComponent, ReportingVariablesRecordsTabulationComponent],
            imports: [
                HttpClientTestingModule, 
                LoggerModule.forRoot({ serverLoggingUrl: '/api/logs', level: NgxLoggerLevel.TRACE, serverLogLevel: NgxLoggerLevel.OFF })],
            providers: [
                DecimalPipe, 
                ReportingVariablesRecordsTabulationService, 
                {
        ...
        fixture = TestBed.createComponent(ReportingVariablesRecordsTabulationComponent);
    ...
    it('should display the Reporting Variables headers correctly', () => {
    ...
    it('should trigger the search for Reporting Variables records with the specified search term', () => {

        const searchTermSetter = spyOnProperty(component.reportingVariablesTableService, 'searchTerm', 'set');
    ...
    it('should trigger the loading of the Reporting Variables records page change', () => {

        const pageSetter = spyOnProperty(component.reportingVariablesTableService, 'page', 'set');
    ...
    it('should trigger the loading of the Reporting Variables records page size change', () => {

        const pageSizeSetter = spyOnProperty(component.reportingVariablesTableService, 'pageSize', 'set');
    ...
    it('should trigger the sorting of Reporting Variables records by name', () => {

        const sortColumnSetter = spyOnProperty(component.reportingVariablesTableService, 'sortColumn', 'set');
        const sortDirectionSetter = spyOnProperty(component.reportingVariablesTableService, 'sortDirection', 'set');
