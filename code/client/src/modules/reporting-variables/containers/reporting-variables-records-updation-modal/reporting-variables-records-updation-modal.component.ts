...
import { ReportingVariablesRecordsUpdationComponent } from '@modules/reporting-variables/components/reporting-variables-records-updation/reporting-variables-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';


const LOG_PREFIX: string = "[Reporting Variables Records Updation Modal]";

@Component({
    selector: 'sb-reporting-variables-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './reporting-variables-records-updation-modal.component.html',
    styleUrls: ['reporting-variables-records-updation-modal.component.scss'],
})
export class ReportingVariablesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Reporting Variables records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(ReportingVariablesRecordsUpdationComponent) component!: ReportingVariablesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Reporting Variables records updation component
     */
    onSave() {
