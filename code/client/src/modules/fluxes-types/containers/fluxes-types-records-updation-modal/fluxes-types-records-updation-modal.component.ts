...
import { FluxesTypesRecordsUpdationComponent } from '../../components/fluxes-types-records-updation/fluxes-types-records-updation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';


const LOG_PREFIX: string = "[Fluxes Types Records Updation Modal]";

@Component({
    selector: 'sb-fluxes-types-records-updation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './fluxes-types-records-updation-modal.component.html',
    styleUrls: ['fluxes-types-records-updation-modal.component.scss'],
})
export class FluxesTypesRecordsUpdationModalComponent implements OnInit {
    ...
    // Inject a reference to the Fluxes Types Records updation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(FluxesTypesRecordsUpdationComponent) component!: FluxesTypesRecordsUpdationComponent;
     ...
     * propagates the saving request to the Fluxes Types Records updation component
     */
    onSave() {
