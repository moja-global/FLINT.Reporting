...
import { FluxesTypesRecordsCreationComponent } from '../../components/fluxes-types-records-creation/fluxes-types-records-creation.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription } from 'rxjs';

const LOG_PREFIX: string = "[Fluxes Types Records Creation Modal]";

@Component({
    selector: 'sb-fluxes-types-records-creation-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './fluxes-types-records-creation-modal.component.html',
    styleUrls: ['fluxes-types-records-creation-modal.component.scss'],
})
export class FluxesTypesRecordsCreationModalComponent implements OnInit, OnDestroy {
    ...
    // Inject a reference to the Fluxes Types Records creation component. 
    // This will provide a way of propagating save requests to it
    @ViewChild(FluxesTypesRecordsCreationComponent) component!: FluxesTypesRecordsCreationComponent;
    ...
    constructor(
        public activeFluxesTypesModal: NgbActiveModal,
     ...
     * propagates the saving request to the Fluxes Types Records creation component
     */
    onSave() {
    ...
    onQuit() {
        ...
        this.activeFluxesTypesModal.close();
    }
