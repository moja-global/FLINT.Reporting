...
import { FluxesTypesRecordsDeletionComponent } from '../../components/fluxes-types-records-deletion/fluxes-types-records-deletion.component';
import { NgbActiveModal } from '@ng-bootstrap/ng-bootstrap';
import { NGXLogger } from 'ngx-logger';
import { BehaviorSubject, Subscription, timer } from 'rxjs';

const LOG_PREFIX: string = "[Fluxes Types Records Deletion Modal]";

@Component({
    selector: 'sb-fluxes-types-records-deletion-modal',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './fluxes-types-records-deletion-modal.component.html',
    styleUrls: ['fluxes-types-records-deletion-modal.component.scss'],
})
export class FluxesTypesRecordsDeletionModalComponent implements OnInit {
    ...
    // Inject a reference to the Fluxes Types Records deletion component. 
    // This will provide a way of propagating delete requests to it
    @ViewChild(FluxesTypesRecordsDeletionComponent) component!: FluxesTypesRecordsDeletionComponent;
     ...
     * propagates the deletion request to the Fluxes Types Records creation component
     */
    onDelete() {
