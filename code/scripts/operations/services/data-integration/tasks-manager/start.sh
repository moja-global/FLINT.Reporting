...
# root/project/scripts/operations/services/data-integration/tasks-manager
TASKS_MANAGER_DIR="$(cd "$(dirname "$0")" && pwd)"

# root/project/scripts/operations/services/data-integration
DATA_INTEGRATION_DIR="$(dirname "$TASKS_MANAGER_DIR")"
