...
@SpringBootTest
class LocationLandUsesFluxReportingResultsAllocationServiceIT {
    ...
    public void Given_LocationLandUsesFluxReportingResultsHistories_When_AllocateLocationLandUsesFluxReportingResults_Then_TheLocationLandUsesAllocatedFluxReportingResultsWillBeReturned() {
        ...
        assertThat(result.getAllocations().get(result.getAllocations().size() - 1).getAllocations())
                .isEqualTo(expected.getAllocations().get(expected.getAllocations().size() - 1).getAllocations());
