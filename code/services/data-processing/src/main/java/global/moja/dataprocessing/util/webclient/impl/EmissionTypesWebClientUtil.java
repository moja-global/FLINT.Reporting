...
public class EmissionTypesWebClientUtil {
    ...
    public WebClient getEmissionTypesWebClient() {
        ...
        if (emissionTypesWebClient == null) {
            emissionTypesWebClient =
                    WebClient
                            .builder()
                            .baseUrl("http://" + hosts.getEmissionTypesServiceHost())
                            .build();
        }

        return emissionTypesWebClient;
    }
