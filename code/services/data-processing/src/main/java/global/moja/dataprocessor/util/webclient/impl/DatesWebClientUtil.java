...
public class DatesWebClientUtil {
    ...
    public WebClient getDatesWebClient() {
        ...
        if (datesWebClient == null) {
            datesWebClient =
                    WebClient
                            .builder()
                            .baseUrl("http://" + hosts.getDatesServiceHost())
                            .build();
        }

        return datesWebClient;
    }
