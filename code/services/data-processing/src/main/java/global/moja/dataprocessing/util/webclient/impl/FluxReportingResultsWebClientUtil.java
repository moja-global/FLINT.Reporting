...
public class FluxReportingResultsWebClientUtil {
    ...
    public WebClient getFluxReportingResultsWebClient() {
        ...
        if (fluxReportingResultsWebClient == null) {
            fluxReportingResultsWebClient =
                    WebClient
                            .builder()
                            .baseUrl("http://" + hosts.getFluxReportingResultsServiceHost())
                            .build();
        }

        return fluxReportingResultsWebClient;
    }
