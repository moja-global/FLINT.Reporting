...
@ContextConfiguration(initializers = RetrieveDatabaseIT.Initializer.class)
public class RetrieveDatabaseIT {
    ...
    @Test
    public void Given_DatabaseRecordExists_When_GetWithIdParameter_Then_TheDatabaseRecordWithThatIdWillBeReturned() {
        ...
        webTestClient
                ...
                .uri(uriBuilder ->
                        uriBuilder
                                ...
                                .build(Long.toString(database1.getId())))
                .exchange()
                .expectStatus().isOk()
                ...
                .value(response -> {
                            ...
                            Assertions.assertThat(response.getVersion()).isEqualTo(database1.getVersion());
                        }
                );
    }
}
