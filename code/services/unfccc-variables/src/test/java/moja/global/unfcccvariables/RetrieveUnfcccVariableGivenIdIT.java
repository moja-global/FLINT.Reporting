...
@ContextConfiguration(initializers = RetrieveUnfcccVariableGivenIdIT.Initializer.class)
public class RetrieveUnfcccVariableGivenIdIT {
    ...
    @Test
    public void Given_UnfcccVariableRecordExists_When_GetWithIdParameter_Then_TheUnfcccVariableRecordWithThatIdWillBeReturned() {
        ...
        webTestClient
                ...
                .uri(uriBuilder ->
                        uriBuilder
                                .path("/api/v1/unfccc_variables/ids/{id}")
                                .build(id.toString()))
                .exchange()
                .expectStatus().isOk()
