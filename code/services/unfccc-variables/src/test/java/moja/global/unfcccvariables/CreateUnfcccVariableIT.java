...
@ContextConfiguration(initializers = CreateUnfcccVariableIT.Initializer.class)
public class CreateUnfcccVariableIT {
    ...
    @Test
    public void Given_UnfcccVariableDetails_When_Post_Then_UnfcccVariableRecordWillBeCreatedAndReturned() {
