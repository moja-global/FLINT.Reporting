 ...
 */
package global.moja.fluxtypes.configurations;

import io.swagger.v3.oas.annotations.enums.ParameterIn;
import global.moja.fluxtypes.handlers.FluxTypesHandler;
                ...
                .and(route()
                        .POST("/api/v1/flux_types/all",
                                ...
                                ops -> ops
                                        ...
                                        .description("Inserts several Flux Types Records into the database")
                                        .requestBody(
                                                requestBodyBuilder()
                                                        .content(contentBuilder()
                                        ...
                                        .response(
                                                responseBuilder()
                                                        .responseCode("201").description("The Flux Types Records were successfully created")
                                                        .implementationArray(FluxType.class))

                                        .response(
                                                responseBuilder()
                                                        .responseCode("500").description("An unexpected condition was encountered while creating the Flux Types Records")
                                                        .implementation(String.class)))
                        .build()
                ...
                .and(route()
                        .GET("/api/v1/flux_types/all",
                                ...
                                ops -> ops
                                        ...
                                        .description("Retrieves all or some of the Flux Types Records from the database depending on whether or not query parameters were included in the query string")
                                        .parameter(
                                                parameterBuilder()
                                                        .name("ids").in(ParameterIn.QUERY)
                                                        .description("The list of unique identifiers of the Flux Types Records to filter the returned values by")
                                                        .implementation(Long.class))
                                        .parameter(
                                                parameterBuilder()
                                                        .name("name").in(ParameterIn.QUERY)
                                                        .description("The Flux Type name (or name fragment) to filter the returned values by ")
                                                        .implementation(String.class))
                                        .response(
                                                responseBuilder()
                                                        .responseCode("200").description("The Flux Types Records were successfully retrieved")
                                                        .implementationArray(FluxType.class))
                                        .response(
                                                responseBuilder()
                                                        .responseCode("500").description("An unexpected condition was encountered while retrieving the Flux Types Records")
                                                        .implementation(String.class)))
                        .build())
                ...
                .and(route()
                        .PUT("/api/v1/flux_types/all",
                                ...
                                ops -> ops
                                        ...
                                        .description("Updates several Flux Types Records in the database")
                                        .requestBody(
                                                requestBodyBuilder()
                                                        .content(contentBuilder()
                                                                .array(arraySchemaBuilder()
                                        ...
                                        .response(
                                                responseBuilder()
                                                        .responseCode("200").description("The Flux Types Records were successfully updated")
                                                        .implementation(FluxType.class))
                                        .response(
                                                responseBuilder()
                                                        .responseCode("500").description("An unexpected condition was encountered while updating the Flux Types Records")
                                                        .implementation(String.class)))
                        .build())
                                ...
                                ops -> ops
                                        ...
                                        .response(
                                                responseBuilder()
                                                        ...
                                                        .description("The number of Flux Types Records successfully deleted"))
                                        .response(
                                                responseBuilder()
                ...
                .and(route()
                        .DELETE("/api/v1/flux_types/all",
                                ...
                                ops -> ops
                                        ...
                                        .description("Deleted all or some of the Flux Types Records from the database depending on whether or not query parameters were included in the query string")
                                        .parameter(
                                                parameterBuilder()
                                                        .name("ids").in(ParameterIn.QUERY)
                                                        .description("The list of unique identifiers of the Flux Types Records to filter the deleted values by")
                                                        .implementation(Long.class))
                                        .parameter(
                                                parameterBuilder()
                                                        .name("name").in(ParameterIn.QUERY)
                                                        .description("The Flux Type name (or name fragment) filter the deleted values by ")
                                                        .implementation(String.class))
                                        .response(
                                                responseBuilder()
                                                        .responseCode("200").description("The Flux Types Records were successfully deleted")
                                                        .implementation(Integer.class)
                                                        .description("The number of Flux Types Records successfully deleted"))
                                        .response(
                                                responseBuilder()
                                                        .responseCode("500").description("An unexpected condition was encountered while deleting the Flux Types Records")
                                                        .implementation(String.class)))
                        .build()));                        
    }
