...
@ContextConfiguration(initializers = DeleteFluxTypesIT.Initializer.class)
public class DeleteFluxTypesIT {
    ...
    @Test
    public void Given_FluxTypeRecordsExist_When_DeleteAllWithoutFilters_Then_AllFluxTypeRecordsWillBeDeletedAndATotalCountOfAffectedRecordsReturned() {
