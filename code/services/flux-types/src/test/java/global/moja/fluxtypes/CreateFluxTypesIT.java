...
public class CreateFluxTypesIT {
    ...
    static final FluxType fluxType5;
    ...
    static {
        ...
        fluxType5 =
                new FluxTypeBuilder()
                        .name("Fifth FluxType")
                        .description("Fifth Flux Type Description")
                        .build();
    }
    ...
    public void Given_FluxTypeDetailsList_When_PostAll_Then_FluxTypeRecordsWillBeCreatedAndReturned() {
        ...
        FluxType[] fluxTypes= new FluxType[]{fluxType4, fluxType5};
        ...
        webTestClient
                ...
                .value(response -> {
                    ...
                    Assertions.assertThat(response.get(0).getName()).isEqualTo(fluxType4.getName());
                    ...
                    Assertions.assertThat(response.get(1).getName()).isEqualTo(fluxType5.getName());
                    Assertions.assertThat(response.get(1).getDescription()).isEqualTo(fluxType5.getDescription());
