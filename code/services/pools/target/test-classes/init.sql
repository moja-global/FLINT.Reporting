...
CREATE TRIGGER PoolVersionInitializationTrigger
BEFORE INSERT
ON pool
FOR EACH ROW
...
INSERT INTO pool(name,description) VALUES('First Pool', null);
INSERT INTO pool(name,description) VALUES('Second Pool',null);
INSERT INTO pool(name,description) VALUES('Third Pool', 'Third Pool Description');
