...
@ContextConfiguration(initializers = RetrievePoolIT.Initializer.class)
public class RetrievePoolIT {
    ...
    @Test
    public void Given_PoolRecordExists_When_GetWithIdParameter_Then_ThePoolRecordWithThatIdWillBeReturned() {

        webTestClient
                .get()
                .uri(uriBuilder ->
                        uriBuilder
                                .path("/api/v1/pools/ids/{id}")
                                .build(Long.toString(pool1.getId())))
                .exchange()
                .expectStatus().isOk()
