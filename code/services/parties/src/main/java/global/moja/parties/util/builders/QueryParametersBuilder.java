...
public class QueryParametersBuilder {
    ...
    public QueryParametersBuilder partyTypeId(ServerRequest request) {
        this.partyTypeId =
                request.queryParam("partyTypeId").isPresent() ?
                        Long.parseLong(request.queryParam("partyTypeId").get()) : null;
        return this;
    }
    ...
    public QueryParameters build() {
        return new QueryParameters(ids, partyTypeId, name);
    }
