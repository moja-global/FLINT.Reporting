...
@ContextConfiguration(initializers = RetrieveFluxesToUnfcccVariablesGivenRulesIT.Initializer.class)
public class RetrieveFluxesToUnfcccVariablesGivenRulesIT {
