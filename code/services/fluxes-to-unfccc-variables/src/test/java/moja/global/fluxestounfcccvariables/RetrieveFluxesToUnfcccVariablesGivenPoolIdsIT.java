...
@ContextConfiguration(initializers = RetrieveFluxesToUnfcccVariablesGivenPoolIdsIT.Initializer.class)
public class RetrieveFluxesToUnfcccVariablesGivenPoolIdsIT {
    ...
    @Test
    public void Given_FluxesToUnfcccVariableRecordsExist_When_GetAllWithStartPoolIdFilter_Then_OnlyUnfcccVariableRecordsWithTheSpecifiedStartPoolIdWillBeReturned() {
        ...
        webTestClient
                ...
                .value(response -> {
                            ...
                            Assertions.assertThat(response.get(0).getEndPoolId())
                                    .isEqualTo(18L);
                            Assertions.assertThat(response.get(0).getUnfcccVariableId())
                                    .isEqualTo(2L);
                            ...
                            Assertions.assertThat(response.get(1).getEndPoolId())
                                    .isEqualTo(19L);
                            Assertions.assertThat(response.get(1).getUnfcccVariableId())
                                    .isEqualTo(3L);
                            ...
                            Assertions.assertThat(response.get(2).getEndPoolId())
                                    .isEqualTo(22L);
                            Assertions.assertThat(response.get(2).getUnfcccVariableId())
                                    .isEqualTo(4L);
    ...
    @Test
    public void Given_FluxesToUnfcccVariableRecordsExist_When_GetAllWithStartAndEndPoolIdsFilter_Then_OnlyUnfcccVariableRecordsWithTheSpecifiedStartAndEndPoolIdsWillBeReturned() {
