...
@ContextConfiguration(initializers = RetrieveLandUseFluxTypeIT.Initializer.class)
public class RetrieveLandUseFluxTypeIT {
    ...
    @Test
    public void Given_LandUseFluxTypeRecordExists_When_GetWithIdParameter_Then_TheLandUseFluxTypeRecordWithThatIdWillBeReturned() {

        webTestClient
                .get()
                .uri(uriBuilder ->
                        uriBuilder
                                .path("/api/v1/land_uses_flux_types/ids/{id}")
                                .build(Long.toString(landUseFluxType1.getId())))
                .exchange()
                .expectStatus().isOk()
