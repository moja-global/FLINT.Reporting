...
@ContextConfiguration(initializers = UpdateConversionAndRemainingPeriodIT.Initializer.class)
public class UpdateConversionAndRemainingPeriodIT {
    ...
    public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
        ...
        webTestClient
                ...
                .body(Mono.just(conversionAndRemainingPeriod1), ConversionAndRemainingPeriod.class)
                .exchange()
                .expectStatus()
                .isOk()
                ...
                .value(response -> {
                            ...
                            Assertions.assertThat(response.getVersion()).isEqualTo(conversionAndRemainingPeriod1.getVersion() + 1);
                        }
                );
    }
}
