...
@Component
@Slf4j
public class SelectReportingTablesByIdsQuery {

	@Autowired
    DatabaseConfig databaseConfig;

	/**
	 * Selects specific reporting table records from the database given their unique identified
	 * @param ids the unique identifiers of the records
	 * @return a list of reporting table records corresponding to the identifiers if found
	 */
	public Flux<ReportingTable> selectReportingTablesByIds(Long[] ids) {

		String query = "SELECT * FROM reporting_table WHERE id in (?)";
