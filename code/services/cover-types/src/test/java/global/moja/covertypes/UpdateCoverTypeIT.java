...
@ContextConfiguration(initializers = UpdateCoverTypeIT.Initializer.class)
public class UpdateCoverTypeIT {
    ...
    public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
        ...
        webTestClient
                ...
                .body(Mono.just(coverType1), CoverType.class)
                .exchange()
                .expectStatus()
                .isOk()
                ...
                .value(response -> {
                            ...
                            Assertions.assertThat(response.getVersion()).isEqualTo(coverType1.getVersion() + 1);
                        }
                );
    }
}
