...
@ContextConfiguration(initializers = CreateUnitCategoriesIT.Initializer.class)
public class CreateUnitCategoriesIT {
    ...
    @Test
    public void Given_UnitCategoryDetailsList_When_PostAll_Then_UnitCategoryRecordsWillBeCreatedAndReturned() {

        UnitCategory u1 = new UnitCategoryBuilder().name("Volume").build();
        UnitCategory u2 = new UnitCategoryBuilder().name("Time").build();
        ...
        webTestClient
                ...
                .value(response -> {
                    ...
                    Assertions.assertThat(response.get(0).getName().equals("Volume") || response.get(0).getName().equals("Time"));
                    Assertions.assertThat(response.get(0).getVersion() == 1);


                    Assertions.assertThat(response.get(1).getId() == 4L || response.get(1).getId() == 5L);
                    Assertions.assertThat(response.get(1).getName().equals("Volume") || response.get(1).getName().equals("Time"));
