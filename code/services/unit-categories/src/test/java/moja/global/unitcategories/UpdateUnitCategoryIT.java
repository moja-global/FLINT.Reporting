...
@ContextConfiguration(initializers = UpdateUnitCategoryIT.Initializer.class)
public class UpdateUnitCategoryIT {
    ...
    public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
        ...
        UnitCategory u = new UnitCategoryBuilder().id(1L).name("AREA").version(1).build();
