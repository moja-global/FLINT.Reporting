...
@ContextConfiguration(initializers = UpdateEmissionTypeIT.Initializer.class)
public class UpdateEmissionTypeIT {
    ...
    public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
        ...
        webTestClient
                ...
                .body(Mono.just(emissionType1), EmissionType.class)
                .exchange()
                .expectStatus()
                .isOk()
                ...
                .value(response -> {
                            ...
                            Assertions.assertThat(response.getVersion()).isEqualTo(emissionType1.getVersion() + 1);
                        }
                );
    }
}
