 ...
 */
package global.moja.emissiontypes.util.builders;
...
public class QueryWhereClauseBuilder {
    ...
    public String build() {
        ...
        //  Abbreviation
        if(queryParameters.getAbbreviation() != null && !queryParameters.getAbbreviation().isBlank()){
            ...
            // Finds any values that have the abbreviation in any position
            query.append("abbreviation LIKE '%").append(queryParameters.getAbbreviation()).append("%'");
