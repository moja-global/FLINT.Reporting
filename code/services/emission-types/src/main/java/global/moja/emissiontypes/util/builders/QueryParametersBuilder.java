...
public class QueryParametersBuilder {
    ...
    public QueryParametersBuilder abbreviation(ServerRequest request) {
        this.abbreviation =
                request.queryParam("abbreviation").isPresent() ?
                        request.queryParam("abbreviation").get() : null;
        return this;
    }

    public QueryParameters build() {
        return new QueryParameters(ids, name, abbreviation);
    }
