...
@Component
@Slf4j
public class DeleteEmissionTypesByIdsQuery {

	@Autowired
    DatabaseConfig databaseConfig;

	/**
	 * Deletes specific emission type records from the database given their unique identifiers
	...
	public Mono<Integer> deleteEmissionTypesByIds(Long[] ids) {
		...
		String query = "DELETE FROM emission_type WHERE id in (?)";
