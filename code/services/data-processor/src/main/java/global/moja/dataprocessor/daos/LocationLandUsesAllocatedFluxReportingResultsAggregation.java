...
@Data
@Builder
public class LocationLandUsesAllocatedFluxReportingResultsAggregation implements
        Comparable<LocationLandUsesAllocatedFluxReportingResultsAggregation> {
    ...
    @Override
    public int compareTo(LocationLandUsesAllocatedFluxReportingResultsAggregation l) {
    ...
    public String toString() {
        return
                String.format(
                        ...
                        "Unit Area Sum: %f, " +
                        "Aggregation: %s",
                        locationId, partyId, tileId, vegetationHistoryId, unitCount, unitAreaSum, aggregations);
    }
