...
import global.moja.dataprocessor.models.FluxToReportingVariable;
...
@Component
@Slf4j
public class FluxesToReportingVariablesEndpointsUtil {
    ...
    public Flux<FluxToReportingVariable> retrieveFluxesToReportingVariables() {
        ...
        return webClientUtil
                .getFluxesToReportingVariablesWebClient()
                .get()
                .uri(uriBuilder ->
                        uriBuilder
                                .path("/all")
                ...
                .retrieve()
                .bodyToFlux(FluxToReportingVariable.class);
