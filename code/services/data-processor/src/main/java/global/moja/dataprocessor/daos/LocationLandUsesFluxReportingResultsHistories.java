...
@Data
@Builder
public class LocationLandUsesFluxReportingResultsHistories implements Comparable<LocationLandUsesFluxReportingResultsHistories> {
    ...
    @EqualsAndHashCode.Exclude
    private List<LocationLandUsesFluxReportingResultsHistory> histories;

    @Override
    public int compareTo(LocationLandUsesFluxReportingResultsHistories l) {
