...
import global.moja.dataprocessor.models.LandUseFluxTypeToReportingTable;
...
public class LandUsesFluxTypesToReportingTablesEndpointsUtil {
    ...
    public Flux<LandUseFluxTypeToReportingTable> retrieveLandUsesFluxTypesToReportingTables() {
        ...
        return webClientUtil
                .getLandUsesFluxTypesToReportingTablesWebClient()
                .get()
                .uri(uriBuilder ->
                        uriBuilder
                                .path("/all")
                ...
                .retrieve()
                .bodyToFlux(LandUseFluxTypeToReportingTable.class);
