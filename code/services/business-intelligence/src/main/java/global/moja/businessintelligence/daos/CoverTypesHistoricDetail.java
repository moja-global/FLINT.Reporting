...
@NoArgsConstructor
@AllArgsConstructor
public class LocationCoverTypesHistoricDetail implements Comparable<LocationCoverTypesHistoricDetail> {
    ...
    @Override
    public int compareTo(LocationCoverTypesHistoricDetail coverType) {
