...
import global.moja.businessintelligence.daos.*;
...
@Component
@Slf4j
public class LocationLandUsesHistoryProcessor {

    @Autowired
    LandUseCategoryAllocationDecisionTree decisionTree;

    public Mono<LocationLandUsesHistories> processLocationLandUsesHistories(
            LocationCoverTypesHistories locationCoverTypesHistories) {

        log.trace("Entering processLocationLandUsesHistories()");
