...
public class QueryParametersBuilder {
    ...
    public QueryParametersBuilder parentLandUseCategoryId(ServerRequest request) {
        this.parentLandUseCategoryId =
                request.queryParam("parentLandUseCategoryId").isPresent() ?
                        Long.parseLong(request.queryParam("parentLandUseCategoryId").get()) : null;
        return this;
    }
    ...
    public QueryParameters build() {
        return new QueryParameters(ids, reportingFrameworkId, parentLandUseCategoryId, coverTypeId, name);
    }
