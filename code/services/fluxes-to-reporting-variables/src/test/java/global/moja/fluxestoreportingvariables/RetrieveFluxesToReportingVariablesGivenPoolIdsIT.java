...
@ContextConfiguration(initializers = RetrieveFluxesToReportingVariablesGivenPoolIdsIT.Initializer.class)
public class RetrieveFluxesToReportingVariablesGivenPoolIdsIT {
