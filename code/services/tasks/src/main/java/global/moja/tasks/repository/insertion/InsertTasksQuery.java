...
@Component
@Slf4j
public class InsertTasksQuery {

    @Autowired
    DatabaseConfig databaseConfig;

    /**
     * Inserts new Tasks records into the database
     *
     * @param tasks an array of beans containing the Tasks records details
     * @return the unique identifiers of the newly inserted Tasks records
     */
    public Flux<Long> insertTasks(Task[] tasks) {

        log.trace("Entering insertTasks");
