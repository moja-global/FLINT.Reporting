...
@ContextConfiguration(initializers = UpdateLandUseFluxTypeToReportingTableIT.Initializer.class)
public class UpdateLandUseFluxTypeToReportingTableIT {
    ...
    public void Given_ModifiedDetailsOfAnExistingRecord_When_Put_Then_TheRecordWillBeUpdatedAndReturnedWithItsVersionIncrementedByOne() {
        ...
        webTestClient
                ...
                .body(Mono.just(landUseFluxTypeToReportingTable1), LandUseFluxTypeToReportingTable.class)
                .exchange()
                .expectStatus()
                .isOk()
                ...
                .value(response -> {
                            ...
                            Assertions.assertThat(response.getReportingTableId()).isEqualTo(landUseFluxTypeToReportingTable1.getReportingTableId());
                            Assertions.assertThat(response.getVersion()).isEqualTo(landUseFluxTypeToReportingTable1.getVersion() + 1);
                        }
                );
    }
}
