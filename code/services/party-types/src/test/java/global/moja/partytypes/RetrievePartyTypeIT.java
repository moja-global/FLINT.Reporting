...
@ContextConfiguration(initializers = RetrievePartyTypeIT.Initializer.class)
public class RetrievePartyTypeIT {
    ...
    @Test
    public void Given_PartyTypeRecordExists_When_GetWithIdParameter_Then_ThePartyTypeRecordWithThatIdWillBeReturned() {

        webTestClient
                .get()
                .uri(uriBuilder ->
                        uriBuilder
                                .path("/api/v1/party_types/ids/{id}")
                                .build(Long.toString(partyType1.getId())))
                .exchange()
                .expectStatus().isOk()
